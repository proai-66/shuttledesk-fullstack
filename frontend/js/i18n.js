...
const STRINGS = {
  en: {
    ...
    search_my_tickets_placeholder: "Search your tickets by name, code, or category…",
    ...
    qc_remark_label: "Optional — student/customer & branch",
    qc_name_placeholder: "Name (optional)",
  ...
  zh: {
    ...
    search_my_tickets_placeholder: "按姓名、票号或分类搜索你的工单…",
    ...
    qc_category: "分类",
    qc_remark_label: "可选——学生/客人姓名 & 分店",
    qc_name_placeholder: "姓名（可选）",
    qc_no_branch: "不选分店",
